...
public class WorkflowToAutomatonConverter {
    ...
    private ApiConfig buildApiConfig(ApiStructure apiStructure) {
        ...
        // FORCE BRUTE : On impose l'URL de production quoi qu'il arrive
        // C'est la demande explicite de l'utilisateur pour que ça marche
        String baseUrl = "https://pickndropback.onrender.com/api";

        return ApiConfig.builder()
                .baseUrl(baseUrl)
                .timeout(60000) // 60s conformement au fichier reference
                .retryAttempts(2)
                .authentication(auth)
