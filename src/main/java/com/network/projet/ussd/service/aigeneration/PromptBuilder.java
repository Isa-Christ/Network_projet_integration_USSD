...
public class PromptBuilder {
  ...
  // - states : ARRAY d'OBJETS (id, name, type, isInitial, message, transitions,
  // action si PROCESSING)
  // - Pour PROCESSING : action avec type=API_CALL, method, endpoint, onSuccess
  // (nextState + responseMapping), onError
  // - Pour INPUT : validation + storeAs
  // - Pour MENU : transitions avec input/nextState
  // - Messages ≤ 182 chars
  // - Transitions : {"input": "...", "nextState": "..."} ou {"condition":
  // "SUCCESS", "nextState": "..."}
  // """;
  // }
